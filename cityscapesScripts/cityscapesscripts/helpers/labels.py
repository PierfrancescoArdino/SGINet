...
# Note that you might want to ignore labels with ID 7 during training.
...
labels = [
    ...
    Label(  'unlabeled'            ,  0 ,        16 , 'void'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'ego vehicle'          ,  1 ,        16 , 'void'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'rectification border' ,  2 ,        16 , 'void'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'out of roi'           ,  3 ,        16 , 'void'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'static'               ,  4 ,        16 , 'void'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'dynamic'              ,  5 ,        16 , 'void'            , 0       , False        , True         , (111, 74,  0) ),
    Label(  'ground'               ,  6 ,        16 , 'void'            , 0       , False        , True         , ( 81,  0, 81) ),
    ...
    Label(  'terrain'              , 22 ,        6 , 'nature'          , 4       , False        , False        , (152,251,152) ),
    Label(  'sky'                  , 23 ,        7 , 'sky'             , 5       , False        , False        , ( 70,130,180) ),
    Label(  'person'               , 24 ,        8 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    Label(  'rider'                , 25 ,        9 , 'human'           , 6       , True         , False        , (7,  0,  0) ),
    Label(  'car'                  , 26 ,        10 , 'vehicle'         , 7       , True         , False        , (  0,  0,142) ),
    ...
    Label(  'trailer'              , 30 ,        11 , 'vehicle'         , 7       , True         , True         , (  0,  0,110) ),
